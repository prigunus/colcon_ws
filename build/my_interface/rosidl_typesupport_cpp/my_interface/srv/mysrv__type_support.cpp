...
static const _Mysrv_Request_type_support_symbol_names_t _Mysrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interface, srv, Mysrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interface, srv, Mysrv_Request)),
  }
};
...
{
  return &::my_interface::srv::rosidl_typesupport_cpp::Mysrv_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_interface, srv, Mysrv_Request)() {
  return get_message_type_support_handle<my_interface::srv::Mysrv_Request>();
}
...
static const _Mysrv_Response_type_support_symbol_names_t _Mysrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interface, srv, Mysrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interface, srv, Mysrv_Response)),
  }
};
...
{
  return &::my_interface::srv::rosidl_typesupport_cpp::Mysrv_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_interface, srv, Mysrv_Response)() {
  return get_message_type_support_handle<my_interface::srv::Mysrv_Response>();
}
...
static const _Mysrv_type_support_symbol_names_t _Mysrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interface, srv, Mysrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interface, srv, Mysrv)),
  }
};
...
{
  return &::my_interface::srv::rosidl_typesupport_cpp::Mysrv_service_type_support_handle;
}
